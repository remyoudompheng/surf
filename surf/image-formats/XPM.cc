...
namespace ImageFormats {
	...
	bool XPM::saveColorImage(const char* fname, RgbBuffer& data, bool fromDlg)
	{
		...
		if (fromDlg) {
			...
			GtkWidget* rbt = gtk_radio_button_new_with_label(0, "Netscape Pallette");
	...
	void XPM::reallySave(const char* filename, RgbBuffer& buffer)
	{
